...
export default async function NewPurchaseOrderPage() {
  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-6">
      <div>
        <h1 className="text-lg font-semibold text-slate-900">New purchase order</h1>
        <p className="text-sm text-slate-500">Raise an order with a supplier, optionally tied to a job.</p>
      </div>
